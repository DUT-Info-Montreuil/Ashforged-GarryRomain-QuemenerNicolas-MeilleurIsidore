...
public class ItemStock {
    ...
    public enum Usuable  implements ItemInterface{
        ground("ground", 1, 0, "ground", true, "#25", "Image/tiles/ground.png"),
        ...
        alluminium("alluminium", 4, 0, "steel", true, "#29", "/universite_paris8/iut/rgarry/ashforged/Image/Usuable/alluminium.png"),
