...
public class Environment {
    ...
    public Environment() {
        ...
        this.mobs.add(new Ennemis("Mongolfière", 15, 4, 5,13,28, 'g' , ItemStock.Weapon.stone_sword, 1664));
        this.mobs.add(new Ennemis("Kozuki", 30, 15, 4, 5,13,'g', ItemStock.Weapon.enma, 1664));
    ...
    public List<NonePlayer> getNonePlayer() {
        return entities;
    }
    ...
    public void generateRandomMob() {
        ...
        for (int i = 0; i + this.mobs.size() < maxMobs; i++) {
            ...
            if (!checkCollision(x, y)) {
                ...
                Ennemis mob = new Ennemis(mobNames[idx], x, y, 13, 45, 56, 'g', ItemStock.Weapon.iron_axe, 13);
                this.mobs.add(mob);
                this.addEntity(mob);
            }
        }
